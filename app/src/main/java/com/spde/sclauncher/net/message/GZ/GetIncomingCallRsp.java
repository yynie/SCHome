...
public class GetIncomingCallRsp extends AbstractISCMessage<GZProtocolHeader> implements IResponse {
    public final static String NAME = GetIncomingCall.NAME;
    ...
    public GetIncomingCallRsp(ISCHeader header) {
        super(header);
    }
    ...
    public List<IncomingCallSet> getDeletePhones() {
        return deletePhones;
    }

    public List<IncomingCallSet> getAddPhones() {
        return addPhones;
    }
    ...
    public void setProtocolBody(String body, int length) throws BodyFormatException {
        ...
        if(fields.length < 4){
            throw new BodyFormatException("GetIncomingCallRsp", "body not completed:" + body);
        }
        //delete
